...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modals)/favorites/favoritesModal` | `/favorites/favoritesModal` | `/(modals)/helpAndSupport/helpAndSupportModal` | `/helpAndSupport/helpAndSupportModal` | `/(modals)/imprintAndDataProtectionContent/imprintAndDataProtectionContentModal` | `/imprintAndDataProtectionContent/imprintAndDataProtectionContentModal` | `/(modals)/offerModal/OfferModal` | `/offerModal/OfferModal` | `/(modals)/offerModal/offerModalStyleSheet` | `/offerModal/offerModalStyleSheet` | `/(modals)/permissions/permissionsModal` | `/permissions/permissionsModal` | `/(modals)/pointsReward/pointsRewardModal` | `/pointsReward/pointsRewardModal` | `/(modals)/rentalHistory/rentalHistoryModal` | `/rentalHistory/rentalHistoryModal` | `/(modals)/savedPaymentInformation/savedPaymentInformationModal` | `/savedPaymentInformation/savedPaymentInformationModal` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/four` | `/four` | `/(tabs)/` | `/(tabs)` | `/(tabs)/three` | `/three` | `/(tabs)/two` | `/two` | `/+html` | `/dummyData/bikeCompanyData` | `/dummyData/newBike` | `/modal` | `/stylesheets/bikesStyleSheets` | `/stylesheets/homeStyleSheet` | `/stylesheets/mapStyleSheet` | `/stylesheets/profileStyleSheet` | `/types/types`;
  // prettier-ignore
